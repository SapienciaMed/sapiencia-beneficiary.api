...
import { IAttentionsFilter, IBeneficiaryFilter, IPQRSDFFilter } from "App/Interfaces/BeneficiaryInterfaces";
...
export default class BeneficiaryController {
  ...
  public async getAttentionsPaginated (ctx:HttpContext) {
    ...
    try{
      ...
      const AttentionsFound = await BeneficiaryProvider.getAttentionsPaginated(payload)
